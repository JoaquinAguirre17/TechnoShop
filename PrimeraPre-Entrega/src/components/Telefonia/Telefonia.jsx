  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const telefoniaProducts = response.data.filter(
          (product) => product.categoria === 'Telefonia'
        );
        setProducts(telefoniaProducts); // Guardamos solo los productos electrónicos
      } catch (error) {
